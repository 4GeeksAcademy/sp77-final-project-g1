...
Revision ID: 0fd67998d691
Revises: 
Create Date: 2024-10-14 19:18:23.752002
...
def upgrade():
    ...
    sa.Column('companany_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['companany_id'], ['companies.id'], ),
    sa.PrimaryKeyConstraint('id'),
